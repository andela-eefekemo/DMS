...
class RoleActions {
  ...
  */
  static createRole(roleContent) {
    return dispatch => axios.post('/api/v1/roles', roleContent)
      .then((response) => {
  ...
  */
  static viewRole() {
    return dispatch => axios.get('/api/v1/roles')
      .then((response) => {
  ...
  */
  static updateRole(roleContent, id) {
    return dispatch => axios.put(`/api/v1/roles/${id}`, roleContent)
      .then((response) => {
        if (response.status === 200) {
          return dispatch({
  ...
  */
  static deleteRole(id) {
    return dispatch => axios.delete(`/api/v1/roles/${id}`)
      .then((response) => {
        if (response.status === 200) {
          return dispatch({
